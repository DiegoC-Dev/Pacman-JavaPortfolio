...
public class ClydeGui extends Clyde{
	Graphics graphics;
	private static ClydeGui instance;
	private static MyRectangle2D virtualClyde;
	
	private ClydeGui() {
		super();
		virtualClyde = getVirtualFigure();
	}
...
//		System.out.println(moveTimer);
	...
	public static ClydeGui getInstance() {
		instance = instance==null?new ClydeGui():instance;
		return instance;
	}
//	public static double getBlinkyDirection() {
//		return blinkyDirection;
//	}
	public static MyRectangle2D getvirtualClyde() {
		return virtualClyde;
	}
