...
public class InkyGui extends Inky{
	Graphics graphics;
	private static InkyGui instance;
	private static MyRectangle2D virtualInky;
	
	private InkyGui() {
		super();
		virtualInky = getVirtualFigure();
	}
...
//		System.out.println(moveTimer);
	...
	public static InkyGui getInstance() {
		instance = instance==null?new InkyGui():instance;
		return instance;
	}
//	public static double getBlinkyDirection() {
//		return blinkyDirection;
//	}
	public static MyRectangle2D getvirtualInky() {
		return virtualInky;
	}
