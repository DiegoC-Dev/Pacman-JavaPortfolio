...
public class PinkyGui extends Pinky{
	Graphics graphics;
	private static PinkyGui instance;
	private static MyRectangle2D virtualPinky;
	
	private PinkyGui() {
		super();
		virtualPinky = getVirtualFigure();
	}
...
//		System.out.println(moveTimer);
	...
	public static PinkyGui getInstance() {
		instance = instance==null?new PinkyGui():instance;
		return instance;
	}
//	public static double getBlinkyDirection() {
//		return blinkyDirection;
//	}
	public static MyRectangle2D getvirtualPinky() {
		return virtualPinky;
	}
